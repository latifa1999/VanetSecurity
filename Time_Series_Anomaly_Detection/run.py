...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_id', type=str, required=True, default='testM', help='model id')
    parser.add_argument('--model', type=str, required=True, default='TimesNet',
                        help='model name, options: [Informer, TimesNet]')

    # data loader
    parser.add_argument('--data', type=str, required=True, default='veremi', help='dataset type')
    parser.add_argument('--root_path', type=str, default='/dataset/', help='root path of the data file')
    parser.add_argument('--data_path', type=str, default='Veremi.csv', help='data file')
    ...
    if args.finetune:
        exp = Exp(args)
        setting = '{}_finetune_{}_{}_{}_ft{}_sl{}_ll{}_pl{}_dm{}_nh{}_el{}_dl{}_df{}'.format(
        ...
        exp.finetune(setting, args.pretrained_model)
